...
public class ApplicationManager {
    ...
    public static class Strings {
        ...
        public static final String SUBJECT_NAME_UNDEFINED = "Unknown Name";

        public static final String SUBJECT_TYPE_EXCERSISES = "Excersies";
        ...
        public static final String SUBJECT_TYPE_UNDEFINED = "Unknown Type";
        ...
        public static final String DAY_UNDEFINED = "Unknwon Day";

        public static final String TEACH_UNDEFINED = "Unknwon Teacher";
